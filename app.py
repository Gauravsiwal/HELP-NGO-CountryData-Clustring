...
st.subheader('This application will help to idenfity the develeopment category of the country using socio-economic factors. Origional data has been clusterd using KMeans.')

# Lets take the inputs
gpp = st.number_input('Enter the GPPP of a country (GDP per population)')
